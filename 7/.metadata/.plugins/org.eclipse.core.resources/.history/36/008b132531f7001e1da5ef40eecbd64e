...
//	字符串补零
	...
	//Author：liuwei
	//Date：2022/03/25
	//Description：显示组号信息。组号"10"的汉字为"十"，转换为4位四进制数为 0022Q
	public void show_group_number_open()
	{
		...
		updateText((float) 0.022); //数码管显示4位四进制数
	...
	//组长姓氏的汉字为"刘"，该姓氏的拼音首字母小写为"l"，其ASCII码为 0110 1100B，转换成4位四进制数为 1230Q
	...
	//周志员姓氏的汉字为"张"，该姓氏的拼音首字母小写为"z"，其ASCII码为 0111 1010B，转换成4位四进制数为 1322Q
	...
	//需求员姓氏的汉字为"臧"，该姓氏的拼音首字母小写为"z"，其ASCII码为 0111 1010B，转换成4位四进制数为 1322Q
	...
	//优裁员姓氏的汉字为"边"，该姓氏的拼音首字母小写为"b"，其ASCII码为 0110 0010B，转换成4位四进制数为 1202Q
	public void show_first_name_opt_open()
	{
		/********请在下方区域编写代码及注释，实现利用点阵和数码管显示优裁员姓氏相关信息的功能********/
		
		updateText((float) 1202); //数码管显示4位四进制数
	...
	//展示员姓氏的汉字为"李"，该姓氏的拼音首字母小写为"l"，其ASCII码为 0110 1100B，转换成4位四进制数为 1230Q
